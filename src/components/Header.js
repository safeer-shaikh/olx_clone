                        ...
                        <div className="input-group-append">
                            ...
                            <div className="dropdown-menu mainDropDown">
                                ...
                                <ul className="locationList">
                                    <li><Link to="/" data-modal-target="#locationmodal"><i className="fa fa-map-marker"></i> punjab</Link></li>
                                    <li><Link to="/" data-modal-target="#locationmodal"><i className="fa fa-map-marker"></i> Islamabad Capital Territory</Link></li>
                                    <li><Link to="/" data-modal-target="#locationmodal"><i className="fa fa-map-marker"></i> Sindh</Link></li>
                                    <li><Link to="/" data-modal-target="#locationmodal"><i className="fa fa-map-marker"></i> Khyber Pakhtunkhwa</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
